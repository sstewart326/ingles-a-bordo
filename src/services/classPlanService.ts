...
// Helper function to log operations in development
const logOperation = (operation: string, data?: any) => {
  if (process.env.NODE_ENV === 'development') {
    console.log(`[ClassPlanService] ${operation}`, data ? data : '');
  }
};
...
export const getStudentClassPlans = async (studentEmail: string, month: number, year: number): Promise<ClassPlan[]> => {
  try {
    logOperation('Getting class plans', { studentEmail, month, year });
    ...
    logOperation('Error getting class plans', error);
    throw error;
  }
};
...
export const createClassPlan = async (
  ...
  try {
    logOperation('Creating class plan', { studentEmail, month, year });
    ...
    logOperation('Error creating class plan', error);
    throw error;
  }
};
...
export const addClassPlanItem = async (
  ...
  try {
    logOperation('Adding class plan item', { planId, title });
    ...
    logOperation('Error adding class plan item', error);
    throw error;
  }
};
...
export const updateClassPlanItem = async (
  ...
  try {
    logOperation('Updating class plan item', { planId, itemId, updates });
    ...
    logOperation('Error updating class plan item', error);
    throw error;
  }
};
...
export const deleteClassPlanItem = async (planId: string, itemId: string): Promise<void> => {
  try {
    logOperation('Deleting class plan item', { planId, itemId });
    ...
    logOperation('Error deleting class plan item', error);
    throw error;
  }
};
...
export const deleteClassPlan = async (planId: string): Promise<void> => {
  try {
    logOperation('Deleting class plan', { planId });
    await deleteDoc(doc(db, COLLECTION_PLANS, planId));
  } catch (error) {
    logOperation('Error deleting class plan', error);
    throw error;
  }
};
...
export const getClassPlanTemplates = async (): Promise<ClassPlanTemplate[]> => {
  try {
    logOperation('Getting class plan templates');
    ...
    logOperation('Error getting class plan templates', error);
    throw error;
  }
};
...
export const createClassPlanTemplate = async (
  ...
  try {
    logOperation('Creating class plan template', { name });
    ...
    logOperation('Error creating class plan template', error);
    throw error;
  }
};
...
export const applyTemplateToClassPlan = async (
  ...
  try {
    logOperation('Applying template to class plan', { planId, templateId });
    ...
    logOperation('Error applying template to class plan', error);
    throw error;
  }
};
...
export const deleteClassPlanTemplate = async (templateId: string): Promise<void> => {
  try {
    logOperation('Deleting class plan template', { templateId });
    await deleteDoc(doc(db, COLLECTION_TEMPLATES, templateId));
  } catch (error) {
    logOperation('Error deleting class plan template', error);
    throw error;
  }
};
...
export const getClassPlanTemplate = async (templateId: string): Promise<ClassPlanTemplate> => {
  try {
    logOperation('Getting class plan template', { templateId });
    const templateRef = doc(db, COLLECTION_TEMPLATES, templateId);
    ...
    logOperation('Error getting class plan template', error);
    throw error;
  }
};
...
export const updateClassPlanTemplate = async (
  ...
  try {
    logOperation('Updating class plan template', { templateId, updates });
    const templateRef = doc(db, COLLECTION_TEMPLATES, templateId);
    ...
    logOperation('Error updating class plan template', error);
    throw error;
  }
};
...
export const insertItemBefore = async (
  ...
  try {
    logOperation('Inserting item before', { classPlanId, beforeItemId, title });
    ...
    logOperation('Error inserting item before', error);
    throw error;
  }
}; 